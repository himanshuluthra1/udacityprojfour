[![himanshuluthra1](https://circleci.com/gh/himanshuluthra1/udacityprojfour.svg?style=svg)](https://app.circleci.com/pipelines/github/himanshuluthra1/udacityprojfour)
...
- In the `./upload_docker.sh` file, edit the dockerpath (line 8) and change the docker username to a personalized one (or leave it as is, to use the public himanshuluthra/microproject:v1.0.0)
